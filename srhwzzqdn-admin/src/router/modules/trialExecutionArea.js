...
const dailyTrialRun = () =>
  import('@/views/trialExecutionArea/dailyTrialRun.vue')
const businessExperimentRun = () =>
  import('@/views/trialExecutionArea/businessExperimentRun.vue')
const humanNatureExperimentRun = () =>
