...
const commonKnowledgeExtract = () => import('@/views/knowledgeExtractArea/commonKnowledgeExtract.vue')
const workKnowledgeExtract = () => import('@/views/knowledgeExtractArea/workKnowledgeExtract.vue')
const communicateKnowledgeExtract = () => import('@/views/knowledgeExtractArea/communicateKnowledgeExtract.vue')
const cultureKnowledgeExtract = () => import('@/views/knowledgeExtractArea/cultureKnowledgeExtract.vue')
const lateralKnowledgeExtract = () => import('@/views/knowledgeExtractArea/lateralKnowledgeExtract.vue')
