...
const rowMemoryAccess = () =>
  import('@/views/memoryReceptionArea/rowMemoryAccess.vue')
const workMemoryAccess = () =>
  import('@/views/memoryReceptionArea/workMemoryAccess.vue')
const lifeMemoryAccess = () =>
  import('@/views/memoryReceptionArea/lifeMemoryAccess.vue')
const funMemoryAccess = () =>
  import('@/views/memoryReceptionArea/funMemoryAccess.vue')
const communicateMemoryAccess = () =>
  import('@/views/memoryReceptionArea/communicateMemoryAccess.vue')
const learnMemoryAccess = () =>
  import('@/views/memoryReceptionArea/learnMemoryAccess.vue')
