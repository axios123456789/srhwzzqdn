...
const mentalTopographyBuild = () =>
  import('@/views/firmWorldviewArea/mentalTopographyBuild.vue')
const valuesClusteringAnalysis = () =>
  import('@/views/firmWorldviewArea/valuesClusteringAnalysis.vue')
