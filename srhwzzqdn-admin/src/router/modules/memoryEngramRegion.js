...
const rowMemoryEngram = () => import('@/views/memoryEngramRegion/rowMemoryEngram.vue')
const workMemoryEngram = () => import('@/views/memoryEngramRegion/workMemoryEngram.vue')
const lifeMemoryEngram = () => import('@/views/memoryEngramRegion/lifeMemoryEngram.vue')
const funMemoryEngram = () => import('@/views/memoryEngramRegion/funMemoryEngram.vue')
const communicateMemoryEngram = () => import('@/views/memoryEngramRegion/communicateMemoryEngram.vue')
const learnMemoryEngram = () => import('@/views/memoryEngramRegion/learnMemoryEngram.vue')
