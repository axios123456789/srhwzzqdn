...
const commonKnowledgeBuild = () => import('@/views/knowledgeBuildArea/commonKnowledgeBuild.vue')
const workKnowledgeBuild = () => import('@/views/knowledgeBuildArea/workKnowledgeBuild.vue')
const communicateKnowledgeBuild = () => import('@/views/knowledgeBuildArea/communicateKnowledgeBuild.vue')
const cultureKnowledgeBuild = () => import('@/views/knowledgeBuildArea/cultureKnowledgeBuild.vue')
const lateralKnowledgeBuild = () => import('@/views/knowledgeBuildArea/lateralKnowledgeBuild.vue')
