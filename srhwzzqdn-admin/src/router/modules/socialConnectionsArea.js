...
const relationshipInfo = () =>
  import('@/views/socialConnectionsArea/relationshipInfo.vue')
const interpersonalCommunicationEvent = () =>
  import('@/views/socialConnectionsArea/interpersonalCommunicationEvent.vue')
const psychometricTopologyAnalysis = () =>
  import('@/views/socialConnectionsArea/psychometricTopologyAnalysis.vue')
