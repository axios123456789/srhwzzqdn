...
const basicInformationObservation = () => import('@/views/personalObservationArea/basicInformationObservation.vue')
const spiritualDimensionObservation = () => import('@/views/personalObservationArea/spiritualDimensionObservation.vue')
const knowledgeLevelObservation = () => import('@/views/personalObservationArea/knowledgeLevelObservation.vue')
const assetDynamicsObservation = () => import('@/views/personalObservationArea/assetDynamicsObservation.vue')
const interpersonalRelationshipsObservation = () => import('@/views/personalObservationArea/interpersonalRelationshipsObservation.vue')
