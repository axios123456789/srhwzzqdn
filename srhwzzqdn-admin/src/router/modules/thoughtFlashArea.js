...
const glitchLightDomain = () =>
  import('@/views/thoughtFlashArea/glitchLightDomain.vue')
const flashHaltDarkroom = () =>
  import('@/views/thoughtFlashArea/flashHaltDarkroom.vue')
const flashHaltMindCloudMap = () =>
  import('@/views/thoughtFlashArea/flashHaltMindCloudMap.vue')
