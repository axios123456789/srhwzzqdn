    ...
    <div class="profile-content">
      ...
      <div class="profile-header">
        ...
        <div class="header-right">
          <el-button type="success" icon="Download" @click="exportToWord">
            一键导出
          </el-button>
        </div>
      </div>
      ...
      <div class="profile-card">
        ...
        <el-card class="info-section">
          ...
          <div class="info-grid">
            <div class="info-item">
              <div class="avatar-container">
                <el-avatar :size="120" :src="profile.personPicture || ''">
                  <span v-if="!profile.personPicture" class="empty-avatar">
                    未上传
                  </span>
                </el-avatar>
              </div>
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.gender }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.birthDate }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.height }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.weight }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.idNumber }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.ethnicity }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.maritalStatus }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.politicalStatus }"
              >
        ...
        <el-card class="info-section">
          <template #header>
            <div class="section-header">
              ...
              <el-button
                type="primary"
                text
                @click="editSection('contact', '联系方式')"
              >
                编辑
              </el-button>
            </div>
          ...
          <div class="info-grid">
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.wechat }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.douyin }"
              >
            ...
            <div class="info-item">
              ...
              <div
                ...
                :class="{
                  'empty-data':
                    !profile.hometownAddressText &&
                    !profile.hometownAddressList,
                }"
              >
                <template
                  v-if="
                    profile.hometownAddressText || profile.hometownAddressList
                  "
                >
            ...
            <div class="info-item">
              ...
              <div
                ...
                :class="{
                  'empty-data':
                    !profile.currentAddressText && !profile.currentAddressList,
                }"
              >
                <template
                  v-if="
        ...
        <el-card class="info-section">
          <template #header>
            <div class="section-header">
              ...
              <el-button
                type="primary"
                text
                @click="editSection('education', '教育背景')"
              >
                编辑
              </el-button>
            </div>
          ...
          <div class="timeline-container">
            ...
            <div
              v-if="
                !profile.sysPersonSchoolInfoList ||
                  profile.sysPersonSchoolInfoList.length === 0
              "
          ...
          <div class="info-grid">
            <div class="info-item">
              ...
              <div
                ...
                :class="{
                  'empty-data':
                    !profile.certificateList ||
                    profile.certificateList.length === 0,
                }"
              >
                <el-tag
            ...
            <div class="info-item full-width">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.campusExperience }"
              >
        ...
        <el-card class="info-section">
          ...
          <div class="info-grid">
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.jobTitle }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.jobType }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.company }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.jobStartDate }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.workYears }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.salary }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.position }"
              >
        ...
        <el-card class="info-section">
          ...
          <div class="info-grid">
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.bankAccount }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.deposit }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': profile.hasDriverLicense === null }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.bloodType }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.allergyHistory }"
              >
            ...
            <div class="info-item">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.chronicDiseases }"
              >
            ...
            <div class="info-item">
              ...
              <div
                ...
                :class="{
                  'empty-data':
                    !profile.hobbyList || profile.hobbyList.length === 0,
                }"
              >
                <el-tag
                ...
                <span
                  v-if="!profile.hobbyList || profile.hobbyList.length === 0"
                >
                  <el-icon><Warning /></el-icon>
                  未填写
                </span>
            ...
            <div class="info-item">
              ...
              <div
                ...
                :class="{
                  'empty-data':
                    !profile.languageList || profile.languageList.length === 0,
                }"
              >
                <el-tag
            ...
            <div class="info-item full-width">
              ...
              <div
                class="info-value"
                :class="{ 'empty-data': !profile.personalStatement }"
              >
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="头像">
                ...
                >
                  <img
                    v-if="profile.personPicture"
                    :src="profile.personPicture"
                    class="avatar"
                  />
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="籍贯地址">
                <el-cascader
                  v-model="profile.hometownAddressList"
      ...
      <div v-else-if="currentEditSection === 'education'">
        <el-form label-width="140px">
          ...
          >
            ...
            <el-row>
              <el-col :span="24">
                <el-button type="danger" @click="removeEducation(index)">
                  删除此经历
                </el-button>
              </el-col>
            </el-row>
...
import {
  DeletePersonSchoolInfoById,
  EditPersonInfo,
  GetPersonInfo,
} from '@/api/sysPersonInfo'
...
const displayEthnicity = computed(() => {
  const item = ethnicityItem.value.find(
    e => e.value === profile.value.ethnicity
  )
  return item ? item.text : ''
})
//婚姻状况响应式
const displayMaritalStatus = computed(() => {
  const item = maritalStatusItem.value.find(
    e => e.value === profile.value.maritalStatus
  )
  return item ? item.text : ''
})
//政治面貌响应式
const displayPoliticalStatus = computed(() => {
  const item = politicalStatusItem.value.find(
    e => e.value === profile.value.politicalStatus
  )
  return item ? item.text : ''
})
//性别响应式
...
const getCurrentPersonInfo = async () => {
  ...
  if (data == null) {
    ...
    if (
      profile.value.personPicture == null ||
      profile.value.personPicture == ''
    ) {
      profile.value.personPicture =
        'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png'
    }
...
const displayHometownAddress = computed(() => {
  const addressFromCode = findAddressText(
    formattedAddressOptions.value,
    profile.value.hometownAddressList
  )
...
const displayCurrentAddress = computed(() => {
  const addressFromCode = findAddressText(
    formattedAddressOptions.value,
    profile.value.currentAddressList
  )
...
const removeEducation = index => {
  ElMessageBox.confirm('此操作将永久移除该记录, 是否继续?', 'Warning', {
    ...
    const { code, message } = await DeletePersonSchoolInfoById(
      profile.value.sysPersonSchoolInfoList[index].id
    )
    if (code === 200) {
...
const displayBloodType = computed(() => {
  const item = bloodTypeItem.value.find(
    e => e.value === profile.value.bloodType
  )
  return item ? item.text : ''
})
//获取兴趣爱好下拉列表选项
...
const saveEdit = async () => {
  ...
  //做校验
  if (
    profile.value.hometownAddressList == null ||
    profile.value.hometownAddressList.length == 0
  ) {
    profile.value.hometownAddress = ''
    profile.value.hometownAddressText = ''
  }
  if (
    profile.value.currentAddressList == null ||
    profile.value.currentAddressList.length == 0
  ) {
    profile.value.currentAddress = ''
    profile.value.currentAddressText = ''
  }
  if (
    profile.value.certificateList == null ||
    profile.value.certificateList.length == 0
  ) {
  ...
  if (
    profile.value.languageList == null ||
    profile.value.languageList.length == 0
  ) {
    profile.value.languages = ''
  }
  // 这里添加保存逻辑
  const { code, message } = await EditPersonInfo(
...
const exportToWord = async () => {
  ...
  docx.Packer.toBlob(doc).then(blob => {
    const fileName = `${profile.value.name ||
      '个人'}-画像信息-${new Date().toLocaleDateString()}.docx`
...
const createTableFromBasicInfo = () => {
  const rows = [
    ...
    createTableRow(
      '身份证号',
      profile.value.idNumber
        ? `**************${profile.value.idNumber.slice(-4)}`
        : '未填写'
    ),
...
const createTableFromContactInfo = () => {
  const rows = [
    createTableRow(
      '手机号码',
      profile.value.phone
        ? profile.value.phone.replace(/(\d{3})\d{4}(\d{4})/, '$1****$2')
        : '未填写'
    ),
...
const createEducationContent = () => {
  ...
  if (
    profile.value.sysPersonSchoolInfoList &&
    profile.value.sysPersonSchoolInfoList.length > 0
  ) {
    profile.value.sysPersonSchoolInfoList.forEach((edu, index) => {
      content.push(
        ...
        new docx.Paragraph({
          children: [
            new docx.TextRun({
              text: `${displaySchoolLevel(edu.schoolLevel) ||
                '未填写'} · ${edu.major || '未填写专业'}`,
            }),
          ],
        }),
...
const createTableFromCareerInfo = () => {
  const rows = [
    ...
    createTableRow(
      '工资(元/月)',
      profile.value.salary ? profile.value.salary.toLocaleString() : '未填写'
    ),
  ...
  const rows = [
    createTableRow(
      ...
      profile.value.bankAccount
        ? `**** **** **** ${profile.value.bankAccount.slice(-4)}`
        : '未填写'
    ),
    createTableRow(
      '存款(元)',
      profile.value.deposit ? profile.value.deposit.toLocaleString() : '未填写'
    ),
    createTableRow(
      '是否有驾驶证',
      profile.value.hasDriverLicense !== null
        ? profile.value.hasDriverLicense == 1
          ? '有'
          : '无'
        : '未填写'
    ),
      ...
      children: [
        ...
        new docx.TableCell({
          children: [
            new docx.Paragraph({
              text:
                profile.value.hobbyList && profile.value.hobbyList.length > 0
                  ? profile.value.hobbyList
                      .map(hobby => displayHobby(hobby))
                      .join('、')
                  : '未填写',
            }),
          ],
      ...
      children: [
        ...
        new docx.TableCell({
          children: [
            new docx.Paragraph({
              text:
                profile.value.languageList &&
                profile.value.languageList.length > 0
                  ? profile.value.languageList
                      .map(lang => displayLanguage(lang))
                      .join('、')
                  : '未填写',
            }),
          ],
